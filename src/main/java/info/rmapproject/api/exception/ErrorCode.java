...
public enum ErrorCode {		
	...
	ER_COULD_NOT_MAP_ACCEPT_PARAMETER_TO_TYPE (Status.INTERNAL_SERVER_ERROR,5001011),
	ER_NO_DEFAULT_SYSTEM_AGENT_SET (Status.INTERNAL_SERVER_ERROR,5001012),
	ER_CANNOT_ACCEPT_CONTENTTYPE_PROVIDED (Status.INTERNAL_SERVER_ERROR,5001013),
	ER_COULD_NOT_MAP_CONTENTTYPE_PARAMETER_TO_TYPE (Status.INTERNAL_SERVER_ERROR,5001014),
	ER_PROCESSING_SYSTEMAGENT (Status.INTERNAL_SERVER_ERROR, 5001015),
	ER_NO_RMAPSYSTEMAGENT (Status.INTERNAL_SERVER_ERROR, 5001016),
	...
	ER_CORE_COULDNT_RETRIEVE_STMT_RELATEDOBJS (Status.INTERNAL_SERVER_ERROR, 5002028),
