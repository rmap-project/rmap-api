...
public class AgentResponseManager {
	...
	Response response = null;
		...
		try	{
			...
			String newAgentUrl = URLUtils.makeAgentUrl(sAgentURI); 
	...
	public Response tombstoneRMapAgent(String agentUri, URI sysAgentUri) throws RMapApiException {
		...
		try	{		
			...
			String newEventURL = URLUtils.makeEventUrl(sEventURI); 
			String origAgentUrl = URLUtils.makeAgentUrl(agentUri); 
			String linkRel = "";
	...
	public Response getRMapAgentEvents(String agentUri, BasicOutputType returnType) throws RMapApiException {
		...
		try {
    		...
    		response = Response.status(Response.Status.OK)
							...
							.location(new URI (URLUtils.makeAgentUrl(agentUri)))
							.build();
	...
	public Response getRMapAgentRepresentations(String nonRmapAgentUri, String creatorUri, BasicOutputType returnType) throws RMapApiException	{
		...
		try {			
			...
			response = Response.status(Response.Status.OK)
						.entity(outputString.toString())
						.location(new URI (URLUtils.makeAgentUrl(nonRmapAgentUri)))
						.build();    			
		} 
		catch(RMapApiException ex)	{
        	throw RMapApiException.wrap(ex);
